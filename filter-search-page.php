...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Main Filter Box */
        .filter-box {
            background-color: #2b3a55; /* Slightly lighter dark blue for the box */
            border-radius: 16px;
            padding: 1.5rem;
            flex: 2.5;
        ...
        .mood-btn.active {
            background-color: #bae6fd; /* Light blue active state */
        ...
        .dropdown-section {
            ...
            flex-direction: column;
            gap: 0.8rem;
            padding-top: 1.8rem; /* Align with mood buttons */
        }
        ...
        .dest-title {
            ...
            margin-bottom: 0.5rem;
            line-height: 1.3;
            min-height: 2.6em; /* Keeps titles aligned even if one line */
        }
